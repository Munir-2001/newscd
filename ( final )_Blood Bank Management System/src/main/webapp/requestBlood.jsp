...
<%
  ...
  {
	  %>
	  <center><font color="red" size="5">Invalid Data Entered!Try Again!</font></center>
  <%
  }
  %>
<% 
...
try
{
	...
	<div class=".c">
	<h1 style="color:red;">Recipient ID: <%out.print(id); %></h1>
	<% 
	}
catch(Exception e)
{}
...
<h2><font color="black"> Recipient Name</h2>
