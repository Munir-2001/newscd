...
<hr>
<h2><font color="black" >Email</h2>
<input type="email" placeholder="Enter Email" name="email">
<hr>
<h2><font color="black" >Blood Group</h2>
...
<hr>
<h2><font color="black" >Address</h2>
