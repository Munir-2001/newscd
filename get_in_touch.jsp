...
<label>Call Us (24*7) <span class="details"><br>021-323456789<br>(+92)9409324362</span></label>
</div>
<div class="icon3">
<span class="box">
<i class="fa  fa-envelope-o fa-2x" aria-hidden="true"> </i>
</span>
<label>Mail development team<span class="details"><br>Elprogrammers2.0@BBMS.com</span></label>
</div>
<div class="contactbox">
<h3> Contact hospitals and blood bank of choice </h3>
<form id="myform" action="../java/B24U/GetInTouch" method="post">
...
<input type="textarea" name="message" placeholder="Message" required  autocomplete="off"><br>
  <label>Blood bank name</label>
  <span><i class="blood bank" aria-hidden="true"></i></span>
