...
<title>Admin: Request Completed </title>
...
#customers td:nth-child(odd){background-color: #f2f2f2;}
...
try{
	...
	ResultSet rs = st.executeQuery("select * from recipient where status='completed'");
	while(rs.next())
	{	
%>
