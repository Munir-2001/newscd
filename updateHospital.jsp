...
try{
	...
	ResultSet rs = st.executeQuery("select * from hospital where hospital_id='"+id+"'");
	while(rs.next())
	{
%>
<div class="container">
<form action="updateHospitalAction.jsp" method="post">
...
<hr>
<h2>Website</h2>
<input type="text" value="<%=rs.getString(5)%>" name="website">
<br>
<h2>Email</h2>
<input type="email" value="<%=rs.getString(6)%>" name="email">
<br>
<h2>City</h2>
<input type="text" value="<%=rs.getString(7)%>" name="website">
<hr>
